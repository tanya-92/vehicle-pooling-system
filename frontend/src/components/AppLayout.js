    ...
    <div className="min-h-screen w-full bg-[#f3f3f3] text-[#111111] font-sans flex flex-col">
      <header className="sticky top-0 z-40 bg-white border-b border-gray-200 shadow-sm">
        <motion.div
          ...
          className="mx-auto flex h-16 w-full max-w-[1280px] items-center justify-between px-4 sm:px-6 lg:px-10"
        >
            ...
            <motion.div className="relative" ref={dropdownRef}>
              ...
              >
                <motion.div
                  ...
                  className="flex items-center justify-center w-8 h-8 rounded-full bg-black text-white text-sm font-semibold"
                >
